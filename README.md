...
After graduation, I joined in Institute of High Performance Computing (IHPC), Agency for Science, Technology and Research (A\*STAR) as a research scientist until present. The reserach direction is focused on machine learning and optimization algorithms over different use-cases, such as in the fields of maritime and industrial production line, etc.
